...
function compatible(works_min, works_max) {
    ...
    if (currentiOS < works_min) {
        text.innerHTML = "Nécessite  iOS plus ou moin recent contacter notre assistance pour en savoir plus.  &#x1f615; Fonctionne de" + works_min + "à iOS " + works_max + ".";
        text.style.color = "red";
        text_container.style.backgroundColor = "lightpink";
        text_container.style.border = "1px solid red";
    } else if (currentiOS > works_max) {
        text.innerHTML = "Pas encore tester sous votre ios   &#x1f601; Fonctionne de Ios" + works_min + "a iOS " + works_max + ".";
        ...
        text.innerHTML = "Votre version d'iOS est suporter Par ce tweaks! &#x1f60a;";
        text.style.color = "green";
        text_container.style.backgroundColor = "lightgreen";
        text_container.style.border = "1px solid green";
    } else {
        text.innerHTML = "Nous ne pouvons pas determiner votre version ouvrir cette page depuis un iPhone/iPad/iPod/ pour voir la compatibility De cette appareil.";
